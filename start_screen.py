...
def show_start_screen(window):
    ...
    # Создание кнопок
    play_button = Button("Играть", SCREEN_WIDTH // 2 - 100, SCREEN_HEIGHT // 2 - 50, 200, 100, PURPLE, GRAY)
    quit_button = Button("Выйти", SCREEN_WIDTH // 2 - 100, SCREEN_HEIGHT // 2 + 100, 200, 100, PURPLE, GRAY,
                         lambda: pygame.quit())
